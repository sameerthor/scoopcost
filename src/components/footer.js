 ...
 <footer className="footer-box px-lg-5 px-md-3 px-2">
            <div className="row mx-auto">
                ...
                <div className="col-lg-3 col-md-4 col-sm-12 mb-3 footer-links">
                    ...
                    <MainDomainLink href="/sitemap-stores"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M470.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 256 265.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160zm-352 160l160-160c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L210.7 256 73.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0z"/></svg>Sitemap Stores</MainDomainLink>
                </div>
                <div className="col-lg-3 col-md-4 col-sm-12 mb-3 footer-links">
