        ...
        <>
            ...
            <section className="sitePolicy">            
                <div className="container">                   
                    <div className="row">
                        <h1 className="text-center">About Coupontix</h1>
                        <p>
                        Welcome to CouponTix!

                        </p>
                        <p>
                        We are your go-to destination for verified coupon codes, unbeatable deals, and exclusive discounts from your favorite brands. Whether you are shopping for fashion, electronics, groceries or gifts, CouponTix helps you save big with no extra effort.
                        </p>
                        <p>
                        ...
                        <h2>Our Mission</h2>
                        <p>
                        At CouponTix, our mission is simple: to help you save money effortlessly. We understand that everyone loves a good deal and we make it easy for you to discover fantastic savings on the products and services you want. We constantly refresh our offers so you are not stuck with expired codes. Our goal is to give you valid and useful coupons.
                        </p>
                        <h2>What We Offer?</h2>
                        <p>
                        ...
                        <p>
                        We partner with top retailers and trusted brands to bring you the best coupons, many of which are exclusive to CouponTix users. Our deals are updated regularly, so you will always find the latest offers.
                        </p>
                        <h2>How CouponTix Works?</h2>
                        <p>
                        ...
                        <h2>Here’s How Customers Can Save with CouponTix</h2>
                        <ul>
                        ...
                        <ul>
                               ...
                               <li>Free to use: CouponTix is completely free for you to use.</li>
                        ...
                        <h2>Get in Touch</h2>
                        <p>
                        We value your feedback! If you have any questions, suggestions or encounter any issues, please don’t hesitate to contact us at <a href="/contact">https://coupontix.com/contact</a>.
                        </p>
                    </div> 
                </div>   
            </section>        
